<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainForm.aspx.cs" Inherits="Lab08.MainForm" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-input">
                <label for="txtSearch">Search Employee:</label>
                <asp:TextBox ID="txtSearch" runat="server" placeholder="Enter Employee Name"></asp:TextBox>
